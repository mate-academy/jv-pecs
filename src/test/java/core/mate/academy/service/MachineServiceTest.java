...
public class MachineServiceTest {
    ...
    public void fill_bulldozerValue() {
        ...
        machineService.fill(machines, new Bulldozer(brand, constructionYear, condition, fuelType));
    ...
    public void startWorking_bulldozers() {
        List<Bulldozer> bulldozers = List.of(new Bulldozer(brand, constructionYear, condition, fuelType));
