...
public class MachineStrategyImpl implements MachineStrategy {
    private final Map<Class<? extends Machine>, MachineProducer<? extends Machine>> machineProducers;

    public MachineStrategyImpl(Map<Class<? extends Machine>, MachineProducer<? extends Machine>> machineProducers) {
