...
public interface MachineService<M> {
     ...
     */
    void fill(List<? super Bulldozer> machines, Bulldozer value);

    void fill(List<? super Excavator> machines, Excavator value);

    void fill(List<? super Truck> machines, Truck value);
